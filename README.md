...
(If solo) Completed all aspects of the project including data processing, model development, evaluation, and documentation.
(If team) Describe division of work here
